...
import { PlotHistogramDeclaration, PlotLinesDeclaration, ProgressBarDeclaration } from "./widgets/plot";
...
import { TooltipDeclaration, WindowDeclaration } from "./widgets/window";
...
declare namespace Iris {
	...
	export function Window(
		...
		state?: InitialState<WindowDeclaration["State"]>,
	): Window;
	...
	export function MenuToggle(
		args: [Text: string, KeyCode?: Enum.KeyCode, ModifierKey?: Enum.ModifierKey],
		state?: InitialState<MenuToggleDeclaration["State"]>,
	): MenuToggle;
	...
	export function InputText(
		args: [Text?: string, TextHint?: string, ReadOnly?: boolean, MultiLine?: boolean],
		state?: InitialState<InputTextDeclaration["State"]>,
	): InputText;
	...
	export function RadioButton(
		args: [Text?: string, Index?: unknown],
		state?: InitialState<RadioButtonDeclaration["State"]>,
	): RadioButton;

	/* ---------------------------------- TREE ---------------------------------- */
	export type Tree = Widget<TreeDeclaration>;
	export function Tree(
		args: [Text: string, SpanAvailWidth?: boolean, NoIndent?: boolean, DefaultOpen?: true],
		state?: InitialState<TreeDeclaration["State"]>,
	): Tree;

	export type CollapsingHeader = Widget<CollapsingHeaderDeclaration>;
	export function CollapsingHeader(
		args: [Text?: string, DefaultOpen?: true],
		state?: InitialState<CollapsingHeaderDeclaration["State"]>,
	): CollapsingHeader;
	...
	export function InputNum(
		...
		state?: InitialState<InputNumberDeclaration["State"]>,
	): InputNum;
	...
	export function InputVector2(
		...
		state?: InitialState<InputDeclaration<Vector2>["State"]>,
	): InputVector2;
	...
	export function InputVector3(
		...
		state?: InitialState<InputDeclaration<Vector3>["State"]>,
	): InputVector3;

	export type InputUDim = Widget<InputDeclaration<UDim>>;
	export function InputUDim(
		args: [Text?: string, Increment?: UDim, Min?: UDim, Max?: UDim, Format?: string | string[], Prefix?: string[]],
		state?: InitialState<InputDeclaration<UDim>["State"]>,
	): InputUDim;
	...
	export function InputUDim2(
		...
		state?: InitialState<InputDeclaration<UDim2>["State"]>,
	): InputUDim2;

	export type InputRect = Widget<InputDeclaration<Rect>>;
	export function InputRect(
		args: [Text?: string, Increment?: Rect, Min?: Rect, Max?: Rect, Format?: string | string[], Prefix?: string[]],
		state?: InitialState<InputDeclaration<Rect>["State"]>,
	): InputRect;

	export type InputColor3 = Widget<InputColorDeclaration>;
	export function InputColor3(
		args: [Text?: string, UseFloats?: boolean, UseHSV?: boolean, Format?: string | string[]],
		state?: InitialState<InputColorDeclaration["State"]>,
	): InputColor3;

	export type InputColor4 = Widget<InputColor4Declaration>;
	export function InputColor4(
		args: [Text?: string, UseFloats?: boolean, UseHSV?: boolean, Format?: string | string[]],
		state?: InitialState<InputColor4Declaration["State"]>,
	): InputColor4;

	export type InputEnum = Widget<ComboEnumDeclaration>;
	export function InputEnum(
		args: [Text?: string, NoButton?: boolean, NoPreview?: boolean],
		state?: InitialState<ComboEnumDeclaration["State"]>,
		enumType?: Enum,
	): InputEnum;

	/* ---------------------------------- DRAG ---------------------------------- */
	export type DragNum = Widget<InputDeclaration<number>>;
	export function DragNum(
		args: [
			Text?: string,
			Increment?: number,
			Min?: number,
		...
		state?: InitialState<InputDeclaration<number>["State"]>,
	): DragNum;
	...
	export function Combo(
		args: [Text?: string, NoButton?: boolean, NoPreview?: boolean],
		state?: InitialState<ComboDeclaration["State"]>,
	): Combo;

	export type ComboArray = Widget<ComboArrayDeclaration>;
	export function ComboArray(
		args: [Text?: string, NoButton?: boolean, NoPreview?: boolean],
		state?: InitialState<ComboArrayDeclaration["State"]>,
	...
	export function Selectable(
		args: [Text?: string, Index?: unknown, NoClick?: boolean],
		state?: InitialState<SelectableDeclaration["State"]>,
	): Selectable;
	...
	export function ProgressBar(
		...
		state?: InitialState<ProgressBarDeclaration["State"]>,
	): ProgressBar;

	export type PlotLines = Widget<PlotLinesDeclaration>;
	export function PlotLines(
		args: [Text: string, Height: number, Min: number, Max: number, TextOverlay?: string],
		state?: InitialState<PlotLinesDeclaration["State"]>,
	): PlotLines;

	export type PlotHistogram = Widget<PlotHistogramDeclaration>;
	export function PlotHistogram(
		args: [Text: string, Height: number, Min: number, Max: number, TextOverlay?: string, BaseLine?: number],
		state?: InitialState<PlotHistogramDeclaration["State"]>,
	): PlotHistogram;
